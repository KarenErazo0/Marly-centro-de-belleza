                    ...
                    @forelse($servicios as $servicio)
                        ...
                        <label class="tarjeta-servicio tarjeta-servicio-home {{ $seleccionado ? 'seleccionado' : '' }}">
                            ...
                            <div class="caja-imagen-servicio">
                                <img src="{{ str_starts_with($imagenServicio, 'http') ? $imagenServicio : asset('images/services/' . $imagenServicio) }}" alt="{{ $servicio->nombre_servicio }}" class="imagen-servicio" onerror="this.onerror=null;this.src='{{ asset('images/services/default-service.jpg') }}';">
                            </div>
        ...
        <div class="rejilla-contacto-mapa marly-contacto-layout">
            <article class="tarjeta-informacion tarjeta-contacto-principal marly-contacto-card">
                ...
                <div class="marly-contacto-lista">
                    ...
                    <p class="marly-contacto-item">
                        ...
                        <span><strong>Horario:</strong> lunes a viernes de 7:00 a.m. a 7:00 p.m. y sábados y festivos de 8:00 a.m. a 7:00 p.m.</span>
                    </p>
                </div>
                ...
                <div class="redes-contacto marly-contacto-redes">
                    <a href="#" class="marly-contacto-red-btn">
            ...
            <div class="tarjeta-mapa marly-contacto-mapa">
                <iframe
                    ...
                    title="Mapa Marly Centro de Belleza">
                </iframe>
            </div>
        </div>
    </div>
